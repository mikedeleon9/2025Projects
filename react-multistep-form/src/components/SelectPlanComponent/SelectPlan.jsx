...
export default function SelectPlan(){
    ...
    return(
        ...
        <div className="grid grid-cols-3 gap-4 max-h-42">
            <Plans image={arcadeImage} option="Arcade" price={selected === "monthly" ? "9" : "90"}/>
            <Plans image={advanceImage} option="Pro" price={selected === "monthly" ? "12" : "120"}/>
            <Plans image={proImage} option="Advanced" price={selected === "monthly" ? "15" : "150"}/>
        </div>
